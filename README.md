# base-block-explorer-api

Starter for Base explorer API usage.
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/base-block-explorer-api.git
cd base-block-explorer-api
python3 -m venv .venv
